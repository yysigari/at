...
disp(['   Loading CLS magnet lattice with markers ', mfilename,'.m file']);
...
BEND1 = rbend2('BEND', 1.87/15, 0.2617994/15, 0.105, 0, -0.3972, 0.05,'BndMPoleSymplectic4RadPass');
FAMLIST{BEND1}.ElemData.FringeInt2 = 0;
BEND2 = rbend2('BEND', 1.87/15, 0.2617994/15, 0, 0, -0.3972, 0.0,'BndMPoleSymplectic4RadPass');
BEND3 = rbend2('BEND', 1.87/15, 0.2617994/15, 0, 0.105, -0.3972, 0.05,'BndMPoleSymplectic4RadPass');
...
BENDXSR = [BEND1, BEND2, BEND2, BEND2, XSR, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND3];
BENDBMIT = [BMIT, BEND1, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND3];
%BENDBMIT = [SM, BEND1, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND2, BEND3];

%Lattice elements
QFA = quadrupole('QFA', 0.18, QFAK, 'StrMPoleSymplectic4RadPass');
QFB = quadrupole('QFB', 0.18, QFBK, 'StrMPoleSymplectic4RadPass');
QFC = quadrupole('QFC', 0.26, QFCK, 'StrMPoleSymplectic4RadPass');

SF = sextupole('SF', 0.192  , SFK/2, 'StrMPoleSymplectic4RadPass'); %Convention: divide K2 by two
...
CEL   = [AP HCELL HCELR];
%XSR beamline made
HCELRXSR =	[D6 QFC D7 SD D8A BPM D8B BENDXSR D3 QFB D9A COR D9B QFA D10A BPM D10B D1];
CELXSR   = [AP HCELL HCELRXSR];
%BMIT beamline made
