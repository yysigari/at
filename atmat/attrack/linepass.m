...
%  3. ROUT   - 6xN matrix: output coordinates of N particles at the end of LINE
%  4. REFPTS - array of increasing indexes that selects elements
%              between 1 and length(LINE)+1.
%              See further explanation of REFPTS in the 'help' for FINDSPOS
%
%  OUPUTS
%  1. ROUT     - 6x(N*length(REFPTS)) matrix: output coordinates of N particles at
...
%  3. NHIST    - number elements before the loss to be traced (default: 1)
...
%
%  NOTES
%  1. LINEPASS(LINE,RIN,length(LINE)+1) is the same as LINEPASS(LINE,RIN)
%     since the reference point length(LINE)+1 is the exit of the last element
%  2. LINEPASS(LINE,RIN,1) is a copy of RIN since the
