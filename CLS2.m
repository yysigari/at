function CLS2
%CLS2 example lattice definition file
% Created 02/16/2020 
...
disp(' ');
disp('** Loading Canadian Light Source 2.0 lattice in CLS2.m **');
...
%QF and QD valus set to have the tune at (tunevalue1,tunevalue2)
