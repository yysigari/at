%FINDRESPMDEMO response matrix demo for CLS
...
% We will use BPM markers as observation points (BPMs)
...
RX = findrespm(THERING,BPMINDEX ,CORRINDEX, KICKSIZE, 'KickAngle',1,1);
RY = findrespm(THERING,BPMINDEX ,CORRINDEX, KICKSIZE, 'KickAngle',1,2);
